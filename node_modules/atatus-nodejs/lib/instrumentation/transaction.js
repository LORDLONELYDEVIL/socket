...
function Transaction (agent, name, type, opts = {}) {
  ...
  agent._instrumentation.testingObj = true;
...
Transaction.prototype.setCompanyContext = function (context) {
  if (!context) return
  this._company = Object.assign(this._company || {}, context)
}
...
Transaction.prototype.setResponseBody = function (responseBody) {
...
Transaction.prototype.toJSON = function () {
  ...
  if (this.sampled) {
    payload.context = {
      ...
      tags: this._labels || {},
      custom: this._custom || {},
      responseBody: this._responseBody || null,
    }
    ...
    if (this.req) {
      payload.context.request = parsers.getContextFromRequest(this.req, conf)
    }
    if (this.res) {
