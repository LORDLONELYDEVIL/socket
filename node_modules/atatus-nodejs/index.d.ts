...
declare class Agent implements Taggable, StartSpanFn {
  ...
  setCompany (company: CompanyObject): void;
  setCustomData (customData: object): void;
  setResponseBody (body: object | string): void;
  setAnalyticsMask (fn: MaskFn): void;
  setAnalyticsSkip (fn: SkipFn): void;
  setSkip (fn: SkipFn): void;
  setLogBodyContentTypes (
...
interface AgentConfigOptions {
  ...
  analytics?: boolean;
  analyticsCaptureOutgoing?: boolean;
  analyticsOutgoingTimeout?: number;
  analyticsOutgoingOnPatch?: boolean;
  analyticsMask?: MaskFn;
  analyticsSkip?: SkipFn;
  skip?: SkipFn;
  ...
  ignoreStatusCodes?: Array<number>;
...
type CaptureBody = 'request' | 'response' | 'all' | '';
type LogBody = 'request' | 'response' | 'all' | '';
...
type SkipFn = (payload: Payload) => boolean | void;
type MaskFn = (payload: Payload) => Payload | boolean | void;
